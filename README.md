...
## مقدمه
این ریدمی مربوط به پروژه درسی در زمینه برنامه‌نویسی پیشرفته با زبان C++ است که تحت نظر دکتر محسن رحمانیان در دانشگاه جهرم انجام شده است. این پروژه یک اسمبلر است که دستورات اسمبلی سفارشی از فایل ورودی در مسیر "input.txt" را دریافت کرده و با استفاده از زبان CPP این دستورات را پردازش می‌کند.

## مراحل انجام پروژه
1. **خواندن و پردازش دستورات**: این پروژه ابتدا دستورات اسمبلی از فایل ورودی "input.txt" را می‌خواند و آن‌ها را پردازش می‌دهد.
   
2. **حذف فضاهای خالی**: فضاهای خالی موجود در دستورات را حذف می‌کند.
   
3. **مقداردهی اولیه**: متغیرها، ثبات‌ها و برچسب‌ها را با کمک یک حافظه 100 کلمه‌ای مجازی مقداردهی اولیه می‌کند.
   
4. **اجرای دستورات**: دستورات را اجرا کرده و خروجی را در ترمینال نمایش می‌دهد.
   
5. **تعامل با کاربر (در صورت نیاز)**: در صورتی که برنامه‌ها نیاز به تعامل با کاربر و دریافت ورودی از او دارند، این تعامل را انجام می‌دهد.
